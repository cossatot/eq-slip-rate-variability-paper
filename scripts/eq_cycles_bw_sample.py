...
ax2.hist(bw_df.Dn, bins=20, normed=True)
...
if save_figs:
    ...
    f1.savefig('../manuscript/figures/bw_recurrence_dists.pdf', bbox_inches="tight")
    f2.savefig('../manuscript/figures/bw_slip_dist.pdf', bbox_inches="tight")
    f3.savefig('../manuscript/figures/bw_disp_histories.pdf', bbox_inches="tight")
    f4.savefig('../manuscript/figures/bw_event_spacing.pdf', bbox_inches="tight")
    f5.savefig('../manuscript/figures/bw_slip_rate_envelopes.pdf', bbox_inches="tight")
    #f6.savefig('../manuscript/figures/slip_rate_estimates.pdf', bbox_inches="tight")
    f7.savefig('../manuscript/figures/bw_epist_unc.pdf', bbox_inches="tight")
