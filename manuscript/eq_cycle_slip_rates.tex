...
\begin{abstract}
Because of the natural (aleatoric) variability in earthquake
...
important parameter is the coefficient of variation (\(CV\) = standard
...
(\textless{} 5,000 years or 5 mean earthquake cycles) is quite high, varying by 
    a factor of 3 or more from the mean,
...
\(CV\). The natural variability in the slip rate estimates compared to
